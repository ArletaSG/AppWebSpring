...
public class BankomatDTO {
    ...
    private final Boolean czyAktywny; //Boolean a nie boolean, lombok zbuduje w obiekcie z małego booleana metodę is czy aktywny a nie get czy aktywny, duży Boolean, bo wtedy db metoda getter
